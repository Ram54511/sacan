...
//	public static SacanStudentsBlogsUploadFileModel processSaveSacanStudentsBlogsRequestData(String jsonDataForSacanStudentsBlogs) {
//		SacanStudentsBlogsUploadFileModel sacanStudentsBlogsObj = new SacanStudentsBlogsUploadFileModel();
//		try {
